...
def create_reader_with_size(map_file_image, mean_file_image, train, image_height=64, image_width=64, num_channels=3, num_classes=32):
    ...
    size_source = CTFDeserializer(map_file_size)
    return MinibatchSource(image_source)