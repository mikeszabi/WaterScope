...
def create_model_ext(input, ext_values, out_dims):
    ...
    convolutional_layer_1_1  = Convolution((3,3), 48, init=glorot_uniform(), activation=relu, pad=True, strides=(1,1))(input)
...
def create_model_ext3(input, ext_values, out_dims):
    ...
    # in VGG style
    #https://www.cs.toronto.edu/~frossard/post/vgg16/
    convolutional_layer_1_1  = Convolution((5,5), 8, init=glorot_uniform(), activation=relu, pad=True, strides=(1,1))(input)
    convolutional_layer_1_2 = Convolution((9,9), 8, init=glorot_uniform(), activation=relu, pad=True, strides=(1,1))(convolutional_layer_1_1)
    pooling_layer_1 = MaxPooling((3,3), strides=(2,2))(convolutional_layer_1_2)

    convolutional_layer_2_1 = Convolution((5,5), 16, init=glorot_uniform(), activation=relu, pad=True, strides=(1,1))(pooling_layer_1)
    convolutional_layer_2_2 = Convolution((7,7), 16, init=glorot_uniform(), activation=relu, pad=True, strides=(1,1))(convolutional_layer_2_1)
    pooling_layer_2 = MaxPooling((3,3), strides=(1,1))(convolutional_layer_2_2)

    convolutional_layer_3_1 = Convolution((3,3), 32, init=glorot_uniform(), activation=relu, pad=True, strides=(1,1))(pooling_layer_2)
    convolutional_layer_3_2 = Convolution((3,3), 32, init=glorot_uniform(), activation=relu, pad=True, strides=(1,1))(convolutional_layer_3_1)
